...
Source: https://northflank.com/docs/v1/api/team/team-roles/create-or-update-role.md
...
{object}
- `name`: (string) (required) The name of the role. (pattern: ^[a-zA-Z0-9]+((-|\s)[a-zA-Z0-9]+)*$) (min length: 3) (max length: 100)
