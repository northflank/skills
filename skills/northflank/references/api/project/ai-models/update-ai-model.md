...
Source: https://northflank.com/docs/v1/api/project/ai-models/update-ai-model.md
...
- `llmModelDeploymentId`: (string) (required) ID of the AI model

**Request body:**

{object}
- `name`: (string) The name of the AI model. (pattern: ^[a-zA-Z0-9]+((-|\s)[a-zA-Z0-9]+)*$) (min length: 3) (max length: 100)
...
- `--llmModelDeploymentId <llmModelDeploymentId>`: ID of the AI model
