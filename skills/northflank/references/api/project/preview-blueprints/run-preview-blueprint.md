...
- `data`: {object}
  ...
  - `templateId`: (string) (required) ID of the preview blueprint
  - `environmentId`: (string) ID of the preview environment created by this run
...
200 OK: Details about the newly created preview blueprint run.
...
```json
{
  "data": {
    ...
    "templateId": "example-preview-blueprint",
    "environmentId": "example-preview"
  }
}
```
...
#### Example Response
 ...
 Details about the newly created preview blueprint run.
